    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className={`relative md:w-[90%] ${isEven ? "md:ml-16" : "md:mr-16 md:ml-auto"
        ...
        >
          ...
          <motion.button
            ...
            className="relative z-50 px-6 py-3 border-2 border-neon-purple text-white rounded-lg font-medium flex items-center gap-2 transition-all duration-200 m-3"
            onClick={() => router.push("/resume")}
          >
            Explore Resume <ArrowRight className="ml-1" />
          </motion.button>
        </motion.div>
      </motion.div>
